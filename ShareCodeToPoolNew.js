...
const $ = new Env("互助码");
const shareCodes = [{
		zd: $.getdata("zd_shareCode1") || "mlrdw3aw26j3xftb3pgrm3krccu2ylu7tpzg5hq",
		nc: $.getdata("nc_shareCode1") || "aeac5c5ce9df46fa9877b92bb468ab74",
		mc: $.getdata("mc_shareCode1") || "MTAxODc2NTEzNTAwMDAwMDAyMDYwMzk3Mw==",
		ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5m9cZ2X41HRIlC2dS3D0uC0",
		jxgc: $.getdata("jx_shareCode1") || "MccR9ibqWoNrKk40XV4YTA==",
	},
	{
		zd: $.getdata("zd_shareCode2") || "mlrdw3aw26j3xi4c7udwadzq3dqbxtzqhg74mxa",
		nc: $.getdata("nc_shareCode2") || "e570c12d222f4769a928285da6cd7a30",
		mc: $.getdata("mc_shareCode2") || "MTE1NDQ5MzYwMDAwMDAwNDI5MTA0NjM=",
		ddgc: $.getdata("dd_shareCode2") || "T0225KkcRUgeo1eDdEj0kqNedgCjVWnYaS5kRrbA",
		jxgc: $.getdata("jx_shareCode2") || "NlaaM68mnGYuQUWkT2TcaQ==",
	},
];
$.result = [];
